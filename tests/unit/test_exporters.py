...
@pytest.fixture
def sample_stat_result() -> StatResult:
...
def test_csv_exporter(
    ...
    sample_stat_result: StatResult,
    sample_plots: list[PlotResult],
) -> None:
    """Test CsvExporter output."""
    csv_exp = CsvExporter()
    res = csv_exp.export(sample_stat_result, sample_plots, sample_df)
...
def test_json_exporter(
    ...
    res = json_exp.export(sample_stat_result, sample_plots, sample_df)
    ...
    assert data["statistical_result"]["method_name"] == "test_method"
...
def test_pdf_exporter(
    ...
    pdf_exp = PdfExporter()
    res = pdf_exp.export(sample_stat_result, sample_plots, sample_df)
